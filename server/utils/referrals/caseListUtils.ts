...
export default class CaseListUtils {
  ...
  static tableRows(referralSummaries: Array<ReferralSummary>): Array<GovukFrontendTableRow> {
    return referralSummaries.map(summary => {
      ...
      const prisonerName = [summary.prisonerName?.firstName, summary.prisonerName?.lastName]
      ...
      const earliestReleaseDate = summary.sentence?.indeterminateSentence
        ? summary.sentence?.tariffExpiryDate
        : summary.sentence?.paroleEligibilityDate || summary.sentence?.conditionalReleaseDate

      return [
        {
          attributes: {
            'data-sort-value': prisonerName,
          },
        ...
        {
          attributes: {
            'data-sort-value': earliestReleaseDate,
          },
          text: earliestReleaseDate ? DateUtils.govukFormattedFullDateString(earliestReleaseDate) : 'N/A',
        },
        {
          attributes: {
        ...
        {
          attributes: {
            'data-sort-value': summary.sentence?.conditionalReleaseDate,
          },
        ...
        {
          attributes: {
            'data-sort-value': summary.sentence?.paroleEligibilityDate,
          },
        ...
        {
          attributes: {
            'data-sort-value': summary.sentence?.tariffExpiryDate,
          },
        ...
        {
          attributes: {
            'data-sort-value': summary.prisonName,
          },
