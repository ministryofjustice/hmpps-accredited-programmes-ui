...
describe('NewReferralsController', () => {
  ...
  let newReferralsController: NewReferralsController

  beforeEach(() => {
    request = createMock<Request>({ user: { token } })
    response = Helpers.createMockResponseWithCaseloads()
    newReferralsController = new NewReferralsController(
      courseService,
      organisationService,
      personService,
      referralService,
  ...
  describe('start', () => {
    it('renders the referral start template', async () => {
      ...
      const requestHandler = newReferralsController.start()
  ...
  describe('new', () => {
    ...
    it('renders the referral new template', async () => {
      ...
      const requestHandler = newReferralsController.new()
      await requestHandler(request, response, next)
  ...
  describe('create', () => {
    it('asks the service to create a referral and redirects to the show action', async () => {
      ...
      const requestHandler = newReferralsController.create()
      await requestHandler(request, response, next)
  ...
  describe('show', () => {
    it('renders the referral task list page', async () => {
      ...
      const requestHandler = newReferralsController.show()
      await requestHandler(request, response, next)
  ...
  describe('showPerson', () => {
    it("renders the page for viewing a person's details", async () => {
      ...
      const requestHandler = newReferralsController.showPerson()
      await requestHandler(request, response, next)
  ...
  describe('checkAnswers', () => {
    it('renders the referral check answers page', async () => {
      ...
      const requestHandler = newReferralsController.checkAnswers()
      await requestHandler(request, response, next)
  ...
  describe('submit', () => {
    ...
    it('asks the service to update the referral status to submitted and redirects to the complete action', async () => {
      ...
      const requestHandler = newReferralsController.submit()
      await requestHandler(request, response, next)
  ...
  describe('complete', () => {
    describe('when the referral status is `referral_submitted`', () => {
      it('renders the referral complete page', async () => {
        ...
        const requestHandler = newReferralsController.complete()
        await requestHandler(request, response, next)
