  ...
  context('And reviewing risks and needs', () => {
    describe('When reviewing risks and alerts', () => {
      ...
      describe('and there are no risks and alerts', () => {
        it('shows the correct information', () => {
          sharedTests.risksAndNeeds.showsRisksAndAlertsPageWithoutData(ApplicationRoles.ACP_REFERRER)
        })
      })
    })
    ...
    describe('When reviewing Section 8 - Drug misuse', () => {
      describe('and there is drug misuse data', () => {
        it('shows the correct information', () => {
          sharedTests.risksAndNeeds.showsDrugMisusePageWithData(ApplicationRoles.ACP_REFERRER)
        })
      })

      describe('and there is no drug misuse data', () => {
        it('shows the correct information', () => {
          sharedTests.risksAndNeeds.showsDrugMisusePageWithoutData(ApplicationRoles.ACP_REFERRER)
        })
      })
    })
    ...
    describe('When reviewing Section 11 - Thinking and behaving', () => {
      describe('and there is behaviour data', () => {
        it('shows the correct information', () => {
          sharedTests.risksAndNeeds.showsThinkingAndBehavingPageWithData(ApplicationRoles.ACP_REFERRER)
        })
      })

      describe('and there is no behaviour data', () => {
        it('shows the correct information', () => {
          sharedTests.risksAndNeeds.showsThinkingAndBehavingPageWithoutData(ApplicationRoles.ACP_REFERRER)
        })
      })
    })
    ...
    describe('When reviewing Section 12 - Attitudes', () => {
      describe('and there is attitude data', () => {
        it('shows the correct information', () => {
          sharedTests.risksAndNeeds.showsAttitudesPageWithData(ApplicationRoles.ACP_REFERRER)
        })
      })
    ...
    describe('When reviewing Section 13 - Health', () => {
      describe('and there is health data', () => {
        it('shows the correct information', () => {
          sharedTests.risksAndNeeds.showsHealthPageWithData(ApplicationRoles.ACP_REFERRER)
        })
      })

      describe('and there is no health data', () => {
        it('shows the correct information', () => {
          sharedTests.risksAndNeeds.showsHealthPageWithoutData(ApplicationRoles.ACP_REFERRER)
        })
      })
    })
