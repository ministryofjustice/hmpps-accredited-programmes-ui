...
const sharedTests = {
  referrals: {
    ...
    showsAdditionalInformationPage: (role: ApplicationRole): void => {
      ...
      additionalInformationPage.shouldContainShowReferralButtons(path)
    ...
    showsEmptyOffenceHistoryPage: (role: ApplicationRole): void => {
      ...
      offenceHistoryPage.shouldContainShowReferralButtons(path)
    ...
    showsEmptyProgrammeHistoryPage: (role: ApplicationRole): void => {
      ...
      programmeHistoryPage.shouldContainShowReferralButtons(path)
    ...
    showsPersonalDetailsPage: (role: ApplicationRole): void => {
      ...
      personalDetailsPage.shouldContainShowReferralButtons(path)
    ...
    showsSentenceInformationPageWithAllData: (role: ApplicationRole): void => {
      ...
      sentenceInformationPage.shouldContainShowReferralButtons(path)
  ...
  risksAndNeeds: {
    showsAttitudesPageWithData: (role: ApplicationRole): void => {
      ...
      attitudePage.shouldContainShowReferralButtons(path)
    ...
    showsAttitudesPageWithoutData: (role: ApplicationRole): void => {
      ...
      attitudesPage.shouldContainShowReferralButtons(path)
    ...
    showsEmotionalWellbeingPageWithData: (role: ApplicationRole): void => {
      ...
      emotionalWellbeingPage.shouldContainShowReferralButtons(path)
    ...
    showsHealthPageWithData: (role: ApplicationRole): void => {
      ...
      healthPage.shouldContainShowReferralButtons(path)
    ...
    showsLearningNeedsPageWithData: (role: ApplicationRole): void => {
      ...
      learningNeedsPage.shouldContainShowReferralButtons(path)
    ...
    showsLifestyleAndAssociatesPageWithData: (role: ApplicationRole): void => {
      ...
      lifestyleAndAssociatesPage.shouldContainShowReferralButtons(path)
    ...
    showsOffenceAnalysisPageWithData: (role: ApplicationRole): void => {
      ...
      offenceAnalysisPage.shouldContainShowReferralButtons(path)
    ...
    showsRelationshipsPageWithData: (role: ApplicationRole): void => {
      ...
      relationshipsPage.shouldContainShowReferralButtons(path)
    ...
    showsRisksAndAlertsPageWithData: (role: ApplicationRole): void => {
      ...
      risksAndAlertsPage.shouldContainShowReferralButtons(path)
    ...
    showsRoshAnalysisPageWithData: (role: ApplicationRole): void => {
      ...
      roshAnalysisPage.shouldContainShowReferralButtons(path)
    ...
    showsThinkingAndBehavingPageWithData: (role: ApplicationRole): void => {
      ...
      thinkingAndBehavingPage.shouldContainShowReferralButtons(path)
  ...
  statusHistory: {
    showPageWithData: (role: ApplicationRole): void => {
      ...
      statusHistoryPage.shouldContainShowReferralButtons(path)
